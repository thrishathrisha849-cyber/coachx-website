...
export const BASELINE_PERMISSIONS: BaselinePermission[] = [
  ...
  { key: 'course.settings.manage', description: 'View/edit LMS-wide default settings (004 FR-114, FR-110 admin "Settings" nav entry)' },
  { key: 'course.academicIntegrity.manage', description: 'Flag/investigate/resolve academic-integrity cases and their appeals (004 FR-116)' },
  { key: 'course.cohort.manage', description: 'Create/edit cohorts, manage rosters, and set cohort module-unlock schedules (004 FR-012/FR-034, T085)' },
...
export const ROLE_PERMISSION_GRANTS: Record<RoleName, string[]> = {
  ...
  content_manager: [
    ...
    'course.academicIntegrity.manage',
    'course.cohort.manage',
    'content.manage',
  ],
